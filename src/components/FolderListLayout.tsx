...
const FolderListLayout = ({
  ...
  return (
    <div className="rounded bg-white shadow-sm dark:bg-gray-900 dark:text-gray-100">
      <div className="grid grid-cols-14 items-center space-x-1 border-b border-gray-900/10 px-2 dark:border-gray-500/30">
        <div className="col-span-14 py-2 text-xs font-bold uppercase tracking-widest text-gray-600 dark:text-gray-300 md:col-span-8">
          {'Name'}
        </div>
