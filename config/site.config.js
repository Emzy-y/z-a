...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'emzy2020@td8qg.onmicrosoft.com',
  ...
  baseDirectory: process.env.BASE_DIRECTORY || '/Datos',
  ...
  footer:
    '<a href="https://zeroanime20.wordpress.com/" target="_blank" rel="noopener noreferrer">Zero-Anime</a>',
